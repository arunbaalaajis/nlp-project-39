...
def load_custom_bert(model_path):
...
def large_batch_encode(bert_model, batch, encoder_gpus, max_bert_bsz):
    ...
    ptr = 0
    while ptr < N:
        bert_model = load_custom_bert("fine_tuned_model.bin")
        ...
        tem_doc_encoding = all_doc_encoder_layers[0]
...
if __name__ == "__main__":
    ...
    encoder_gpus = [f"cuda:{int(i)}" for i in args.encoder_gpu.split(',')]
