...
def get_dev_paras(data, pred_score, output_path):
    ...
    for case in tqdm(data):
        ...
        while cur_ptr < tem_ptr + len(case['context']):
            #score = pred_score.iloc[cur_ptr, 'prob']
            score = pred_score['prob'].iloc[cur_ptr]
...
if __name__ == "__main__":
    ...
    #features = convert_examples_to_features(examples, label_list, 32, tokenizer, verbose=True)
